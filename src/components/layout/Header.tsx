...
function Header({}: HeaderProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-between border-b-2 border-b-fulltek-sidebar-border px-4 pb-2 pt-5 text-lg font-semibold max-sm:gap-y-3 sm:flex-row sm:px-6 sm:pt-5">
      <div>{t("Orders")}</div>
